...
class Ui_ownerProfile(object):
    ...
    def setupUi(self, name):
        ...
        self.lastname.setGeometry(QtCore.QRect(480, 310, 340, 55))
        font = QtGui.QFont()
        font.setPointSize(18)
        ...
        self.email.setGeometry(QtCore.QRect(80, 400, 340, 55))
        font = QtGui.QFont()
        ...
        self.username.setGeometry(QtCore.QRect(480, 400, 340, 55))
        font = QtGui.QFont()
        font.setPointSize(18)
